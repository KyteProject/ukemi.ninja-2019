...
const WebsiteMeta = ( { data, settings, canonical, title, description, image, type } ) => {
	...
	const ghostDescription =		description ||		data.meta_description ||		data.description ||		config.siteDescriptionMeta ||		ghostSettings.description;

	const ghostTitle = `${title || data.meta_title || data.name || data.title} - ${ghostSettings.title}`;
